...
%% lqr controller
K_pp = place(A,B2,[-0.3,-0.23,-0.02,-0.05]);
A = A-B2*K_pp;
B = [B1 B2];
gamma = 0.9;
Q = C'*C;
...
%K = B2'*P
 ...
 Ac = A-B*K;
 sysCl(1) = ss(Ac,B,C,D)
 [yCl_r1,t11] = step(sysCl(2));
 [ImCl_r1,t12] = impulse(sysCl(2));
 save('time_domain_r1_u2.mat','t11','t12',"ImCl_r1","yCl_r1")
 [yCl_r1,t13] = step(sysCl(1));
 [ImCl_r1,t14] = impulse(sysCl(1));
 save('time_domain_r1_u1.mat','t13','t14',"ImCl_r1","yCl_r1")
%% Visualization
%step response
figure
subplot(2,1,1)
